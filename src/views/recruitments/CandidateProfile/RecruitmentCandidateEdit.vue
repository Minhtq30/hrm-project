      ...
      <navbar-social :isShowSearch="false"
        ><div class="flex grow">
          <div class="flex items-center">
            ...
            <p class="longText">Cập nhật hồ sơ ứng viên</p>
          </div>
        </div></navbar-social
      >
    </template>
            ...
            <div v-show="isInfor == true">
              <div class="form-small">
                ...
                <div>
                  <v-select
                    ...
                    v-model="CandidateDetail.campaign_current_id"
              ...
              <div class="grid grid-cols-2 gap-2 form-small">
                ...
                <div>
                  ...
                  <div>
                    <v-select
                      v-model="CandidateDetail.source"
              ...
              <div class="grid grid-cols-2 gap-2 form-small">
                <div>
                  ...
                  <div>
                    <date-picker
                      v-model="CandidateDetail.birthday"
                    ></date-picker>
                  </div>
                </div>
                <div>
                  ...
                  <div>
                    <v-select
                      ...
                      v-model="CandidateDetail.gender"
                      :searchable="false"
                    ></v-select>
                  </div>
                </div>
                ...
                <div class="grid grid-cols-3 gap-2">
                  <div>
                    <v-select
                      ...
                      v-model="CandidateDetail.place_of_birth_state_id"
                    ></v-select>
                  </div>
                  <div>
                    <v-select
                      ...
                      v-model="CandidateDetail.place_of_birth_district_id"
                    ></v-select>
                  </div>
                  <div>
                    <v-select
                      ...
                      v-model="CandidateDetail.place_of_birth_ward_id"
                    ></v-select>
                  </div>
                </div>
              </div>
                ...
                <div class="grid grid-cols-3 gap-2">
                  <div>
                    <v-select
                      ...
                      placeholder="Chọn tỉnh/thành phố"
                      v-model="CandidateDetail.origin_state_id"
                    ></v-select>
                  </div>
                  <div>
                    <v-select
                      ...
                      placeholder="Chọn quận/huyện"
                      v-model="CandidateDetail.origin_district_id"
                    ></v-select>
                  </div>
                  <div>
                    <v-select
                      ...
                      :reduce="(ward) => ward.ID"
                      placeholder="Chọn xã/phường"
                      v-model="CandidateDetail.origin_ward_id"
                    ></v-select>
                  </div>
                </div>
              </div>
                ...
                <div>
                  ...
                  <div>
                    <input
                      ...
                      class="form-control-input"
                      placeholder="Nhập mã"
                      v-model="CandidateDetail.private_code"
                    />
                  </div>
                </div>
                <div>
                  ...
                  <div>
                    <date-picker
                      v-model="CandidateDetail.private_code_date"
                    ></date-picker>
                  </div>
                </div>
              </div>
              <div class="form-small">
                ...
                <div>
                  <v-select
                    ...
                    v-model="CandidateDetail.private_code_place"
                ...
                <div>
                  ...
                  <div>
                    <v-select
                      ...
                      v-model="CandidateDetail.marital_status"
                      :searchable="false"
                    ></v-select>
                  </div>
                </div>
                <div>
                  ...
                  <div>
                    <input
                      ...
                      v-model="CandidateDetail.nationality"
                    />
                  </div>
                </div>
              </div>
                ...
                <div>
                  ...
                  <div>
                    <v-select
                      ...
                      v-model="CandidateDetail.people"
                ...
                <div>
                  ...
                  <div>
                    <v-select
                      ...
                      v-model="CandidateDetail.religious"
                ...
                <div>
                  ...
                  <div>
                    <input
                      ...
                      class="form-control-input"
                      placeholder="cm"
                      v-model="CandidateDetail.height"
                    />
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div>
                    <input
                      ...
                      class="form-control-input"
                      placeholder="kg"
                      v-model="CandidateDetail.weight"
                    />
                  </div>
                </div>
              </div>
              <div class="form-small">
                ...
                <div>
                  <textarea
                    ...
                    v-model="CandidateDetail.desc_note"
                  ></textarea>
                </div>
              </div>
            </div>
                  ...
                  <div class="grid grid-cols-3 gap-2">
                    <div>
                      <v-select
                        ...
                        placeholder="Chọn tỉnh/thành phố"
                        v-model="CandidateDetail.home_address_state_id"
                      ></v-select>
                    </div>
                    <div>
                      <v-select
                        ...
                        placeholder="Chọn quận/huyện"
                        v-model="CandidateDetail.home_address_district_id"
                      ></v-select>
                    </div>
                    <div>
                      <v-select
                        ...
                        :reduce="(ward) => ward.ID"
                        placeholder="Chọn xã/phường"
                        v-model="CandidateDetail.home_address_ward_id"
                      ></v-select>
                    </div>
                  </div>
                </div>
                  ...
                  <div class="grid grid-cols-3 gap-2">
                    <div>
                      <v-select
                        ...
                        @click.once="loadAllCity()"
                        placeholder="Chọn tỉnh/thành phố"
                        v-model="CandidateDetail.current_address_state_id"
                      ></v-select>
                    </div>
                    <div>
                      <v-select
                        ...
                        placeholder="Chọn quận/huyện"
                        v-model="CandidateDetail.current_address_district_id"
                      ></v-select>
                    </div>
                    <div>
                      <v-select
                        ...
                        :reduce="(ward) => ward.ID"
                        placeholder="Chọn xã/phường"
                        v-model="CandidateDetail.current_address_ward_id"
                      ></v-select>
                    </div>
                  </div>
                </div>
          ...
          <Transition name="slide-up">
            <div v-show="isFamily == true" class="form-plus">
              <div
                ...
                v-if="CandidateDetail.json_family?.length"
              >
              ...
              <div
                v-for="(infoFamily, index) in CandidateDetail.json_family"
                :key="index"
                :name="index"
          ...
          <Transition name="slide-up">
            <div v-show="isSchool == true" class="form-plus">
              <div
                ...
                v-if="CandidateDetail.json_study?.length"
              >
                <div class="form-mid-small px-1">
              ...
              <div
                v-for="(infoSchool, index) in CandidateDetail.json_study"
                :key="index"
                class="form-plus flex items-center -mt-3"
              >
                <div class="form-mid-small px-1">
        ...
        <div title="Kinh nghiệm làm việc">
          ...
          <Transition name="slide-up">
            <div v-show="isExp == true" class="form-plus">
              <div
                class="form-plus flex items-center"
                v-if="CandidateDetail.json_process?.length"
              >
                <div class="form-mid-small px-1">
                  <label for="" class="form-group-label">Từ ngày</label>
                </div>
              ...
              <div
                v-for="(infoExp, index) in CandidateDetail.json_process"
                :key="index"
                class="form-plus flex items-center -mt-3"
                :name="index"
              >
...
export default {
  ...
  setup() {
    ...
    const createFamily = () => {
      ...
      CandidateDetail.value.json_family.push(data);
    };
    const removeFamily = (index) => {
      CandidateDetail.value.json_family.splice(index, 1);
    };
    const createSchool = () => {
      const data = {
        degree_date_from: "",
      ...
      CandidateDetail.value.json_study.push(data);
    };
    const removeSchool = (index) => {
      CandidateDetail.value.json_study.splice(index, 1);
    };
    const createExp = () => {
      const data = {
      ...
      CandidateDetail.value.json_process.push(data);
    };
    const removeExp = (index) => {
      CandidateDetail.value.json_process.splice(index, 1);
    };
    ...
    const UpdateCandidate = () => {
      ...
      const data = {
        ...
        campaign_current_id: CandidateDetail.value.campaign_current_id,
        code: CandidateDetail.value.code,
        name: CandidateDetail.value.name,
        source: CandidateDetail.value.source,
        birthday: CandidateDetail.value.birthday,
        gender: CandidateDetail.value.gender,
        place_of_birth_state_id: CandidateDetail.value.place_of_birth_state_id,
        place_of_birth_district_id:
          CandidateDetail.value.place_of_birth_district_id,
        place_of_birth_ward_id: CandidateDetail.value.place_of_birth_ward_id,
        origin_state_id: CandidateDetail.value.origin_state_id,
        origin_district_id: CandidateDetail.value.origin_district_id,
        origin_ward_id: CandidateDetail.value.origin_ward_id,
        home_address_state_id: CandidateDetail.value.home_address_state_id,
        home_address_district_id:
          CandidateDetail.value.home_address_district_id,
        home_address_ward_id: CandidateDetail.value.home_address_ward_id,
        current_address_state_id:
          CandidateDetail.value.current_address_state_id,
        current_address_district_id:
          CandidateDetail.value.current_address_district_id,
        current_address_ward_id: CandidateDetail.value.current_address_ward_id,
        private_code: CandidateDetail.value.private_code,
        private_code_date: CandidateDetail.value.private_code_date,
        private_code_place: CandidateDetail.value.private_code_place,
        marital_status: CandidateDetail.value.marital_status,
        nationality: CandidateDetail.value.nationality,
        people: CandidateDetail.value.people,
        religious: CandidateDetail.value.religious,
        phone: CandidateDetail.value.phone,
        email: CandidateDetail.value.email,
        desc: CandidateDetail.value.desc,
        desc_note: CandidateDetail.value.desc_note,
        json_family: CandidateDetail.value.json_family,
        json_study: CandidateDetail.value.json_study,
        json_process: CandidateDetail.value.json_process,
      };
      store.dispatch("recruitmentCandidate/EditRecruitmentCandidateAction", {
        data: data,
        toast,
        router,
        ActivatedButton,
