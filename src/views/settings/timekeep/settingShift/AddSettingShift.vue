      ...
      <navbar-social :isShowSearch="false">
        <div class="flex grow">
          <div class="flex items-center">
            ...
            ></div>
            <p class="longText">Tạo mới ca làm việc</p>
          </div>
        </div></navbar-social
      >
    </template>
            ...
            <div v-show="isInfor == true">
              ...
              <div class="grid grid-cols-12 gap-2 form-small">
                <div class="col-span-3">
                  ...
                  <div>
                    <hour-picker v-model="shift.time_start"></hour-picker>
                  </div>
                </div>
                <div class="col-span-3">
                  <label for="" class="form-group-label">Giờ ra</label>
                  <div>
                    <hour-picker v-model="shift.time_end"></hour-picker>
                  </div>
                </div>
              ...
              <div class="grid grid-cols-2 gap-2 form-small">
                <div>
                  ...
                  <div>
                    <hour-picker v-model="shift.time_break_start"></hour-picker>
                  </div>
                </div>
                <div>
              ...
              <div class="grid grid-cols-12 gap-2 form-small">
                <!-- <div class="col-span-6">
                  ...
                  <div>
                    <hour-picker v-model="shift.time_change"></hour-picker>
                  </div>
                </div> -->
                <div class="col-span-6">
              ...
              <div class="grid grid-cols-2 gap-2 form-small">
                <div>
                  <label for="" class="form-group-label">Chek in trước</label>
                  <div>
                    <hour-picker
                      v-model="shift.time_start_interval"
                    ></hour-picker>
                  </div>
                </div>
                <div>
                  ...
                  <div>
                    <hour-picker
                      v-model="shift.time_end_interval"
                    ></hour-picker>
                  </div>
                </div>
              </div>
              ...
              <div class="form-small flex justify-start items-center mt-1">
                <div class="check">
                  <input
                    ...
                    type="checkbox"
                    v-model="shift.auto_checkout_position"
                    true-value="1"
                    false-value="0"
                  />
                  <label for=""></label>
              ...
              <Transition name="slide-fade">
                ...
                >
                  <div>
                    ...
                    <div>
                      <input-position :isMultiple="true"></input-position>
                    </div>
                  </div>
                </div>
              </Transition>
                ...
                <div>
                  ...
                  <div>
                    <selector-gps-view
                      ...
                      :listFinal="shift.gps_location_ids"
    ...
    <template v-slot:sub_footer>
      <div class="bg-slate-100">
        <div class="p-4 text-left">
          <button class="button-modal" @click="createShift()">Cập nhật</button>
...
export default {
  ...
  setup() {
    ...
    const loadGpsLocation = _.debounce((e) => {
      gps.searchGPSAction({ search: e.target.value, EndTimeLoading });
    }, 300);
    const createShift = () => {
      const data = {
        type: shift.type,
        ...
        time_break_start: shift.time_break_start,
        time_break_end: shift.time_break_end,
        is_multiple_interval: shift.is_multiple_interval,
        time_change: shift.time_change,
        type_change: DataTypeFlex.value,
        type_change_apply: DataFlexible.value,
        is_checkinout_auto: shift.is_checkinout_auto,
        time_start_interval: shift.time_start_interval,
        time_end_interval: shift.time_end_interval,
        position_ids: shift.position_ids,
        gps_location_ids: shift.gps_location_ids,
        is_over_day: shift.is_over_day,
        number_work: shift.number_work,
      };
      if (shift.title.length > 0) {
        tk_shift.createShiftAction({
          data,
          toast,
          router,
        });
