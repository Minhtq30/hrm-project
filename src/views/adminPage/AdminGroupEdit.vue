      ...
      <navbar-social :isShowSearch="false"
        ><div class="flex grow">
          <div class="flex items-center">
            ...
            <p class="text-base">Cập nhật nhóm người dùng</p>
          </div>
        </div></navbar-social
      >
    </template>
    <Transition duration="550" name="nested">
      <div class="w-full h-full p-2 cursor-pointer" v-if="isLoading == false">
        <h4 class="form-section-title form-small" @click="isInfor = !isInfor">
              ...
              <div class="mt-[12px]">
                <div class="flex items-center">
                  <input
                    ...
                    type="checkbox"
                    class="w-4 h-4"
                    v-model="GroupDetail.is_default"
                  />
                  <label
                    for="defaultGroup"
                    class="ml-2 text-[12.6px] text-gray-900 cursor-pointer"
                  ...
                  <tr>
                    ...
                    <td class="cellTable">
                      <select
                        ...
                        v-model="manage"
                        :disabled="!personnel || !personnelProfile"
                    ...
                    <td class="cellTable">
                      <div>
                        <select
                          ...
                          v-model="view"
                          :disabled="
                            !personnel || !personnelProfile || !disableView
                          "
                        >
                          <option value="" disabled selected>Chọn quyền</option>
                          <option
                    ...
                    <td class="cellTable text-center">
                      <input
                        ...
                        v-model="create"
                        :disabled="
                          !personnel || !personnelProfile || !disableCheck
                        "
                      />
                    </td>
                    <td class="cellTable text-center">
                  ...
                  <tr>
                    ...
                    <td class="cellTable">
                      <select
                        ...
                        class="form-control-select"
                        v-model="manage1"
                        :disabled="!personnel || !personnelContract"
                    ...
                    <td class="cellTable">
                      <select
                        ...
                        v-model="view1"
                        :disabled="
                          !personnel || !personnelContract || !disableView1
                        "
                      >
                    ...
                    <td class="cellTable text-center">
                      <input
                        ...
                        v-model="create1"
                        :disabled="
                          !personnel || !personnelContract || !disableCheck1
                        "
                      />
                    </td>
                    <td class="cellTable text-center">
                  ...
                  <tr>
                    ...
                    <td class="cellTable text-center">
                      <select
                        ...
                        :disabled="!personnel || !personnelInsurance"
                  ...
                  <tr>
                    ...
                    <td class="cellTable text-center">
                      <select
                        ...
                        :disabled="!timekeepCheck || !timekeep"
                  ...
                  <tr>
                    ...
                    <td class="cellTable text-center">
                      <select
                        ...
                        :disabled="!recruitment || !recruitmentRequest"
                  ...
                  <tr>
                    ...
                    <td class="cellTable text-center">
                      <select
                        ...
                        :disabled="!recruitment || !recruitmentRecruitment"
                        v-on:change="
                          onChangeManageRecruitmentRecruitment($event)
                        "
                      >
                        <option value="" disabled selected>Chọn quyền</option>
                        ...
                        <option
                          value="RECRUITMENT_RECRUITMENT_MANAGE_DEPARTMENT"
                        >
                          Quản lý phòng ban
                        </option>
                      </select>
                  ...
                  <tr>
                    ...
                    <td class="cellTable text-center">
                      <select
                        ...
                        v-model="assetView"
                        :disabled="
                          !asset || !disableCheckAsset || !disableViewAsset
                        "
                      >
                        <option value="" disabled selected>Chọn quyền</option>
                        <option
                  ...
                  <tr>
                    ...
                    <td class="cellTable text-center">
                      <select
                        ...
                        :disabled="!approval || !approvalCheck"
                  ...
                  <tr>
                    ...
                    <td class="cellTable text-center">
                      <select
                        ...
                        v-model="socialView"
                        :disabled="
                          !social || !disableCheckSocial || !disableViewSocial
                        "
                      >
                        <option value="" disabled selected>Chọn quyền</option>
                        <option
                  ...
                  <tr>
                    ...
                    <td class="cellTable text-center">
                      <select
                        ...
                        v-model="wageView"
                        :disabled="
                          !wage || !disableCheckWage || !disableViewWage
                        "
                      >
                        <option value="" disabled selected>Chọn quyền</option>
                        <option
        ...
        <div class="my-4 text-left" v-show="isInfor == false">
    ...
    <template v-slot:sub_footer>
      <div class="bg-slate-100">
        <div class="p-4 text-left">
          <button class="button-modal" @click="updateRoleGroup()">
            Cập nhật
          </button>
...
export default {
  ...
  setup() {
    ...
    const { GroupDetail } = storeToRefs(GroupUser);
    const EndTimeLoading = () => {
      isLoading.value = false;
    };
    GroupUser.ShowDetailGroupAction({
      id: route.params.id,
      EndTimeLoading,
    });
    return {
  ...
  methods: {
    ...
    updateRoleGroup() {
      ...
      const listRoleGroup = {
        ...
        title: this.GroupDetail.title,
        string_roles: stringRoles1,
        is_admin: this.GroupDetail.is_admin,
        is_default: this.GroupDetail.is_default,
      };
      this.GroupUser.UpdateAdminGroupAction({
        data: listRoleGroup,
        router: this.$router,
        toast: this.toast,
      });
    ...
    getMatchingResults(input) {
      const found = this.GroupDetail.string_roles.find(
    ...
    getMatchingResults1(input) {
      const inc = this.GroupDetail.string_roles.find((x) => input.includes(x));
  ...
  updated() {
    this.title = this.GroupDetail.title;
    this.is_admin = this.GroupDetail.is_admin;
    this.is_default = this.GroupDetail.is_default;
    ...
    this.printInsurance = this.getMatchingResults("PERSONNEL_INSURANCE_PRINT");
