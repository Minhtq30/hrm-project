      ...
      <navbar-social :isShowSearch="false">
        <div class="flex grow">
          <div class="flex items-center">
            ...
            <p class="text-base">Tạo nhóm người dùng mới</p>
          </div>
        </div>
      </navbar-social>
    </template>
                ...
                <div class="w-full">
                  <table-responsive :header="header" :isShow="false">
                    ...
                    <tr>
                      ...
                      <td class="cellTable">Đề xuất tuyển dụng</td>
                      <td class="cellTable text-center">
                        <select
                          class="form-control-select"
                    ...
                    <tr>
                      ...
                      <td class="cellTable text-center">
                        ...
                        >
                          ...
                          <option
                            value="RECRUITMENT_RECRUITMENT_MANAGE_COMPANY"
                          >
                            Quản lý công ty
                          </option>
                    ...
                    <tr>
                      ...
                      <td class="cellTable">Bảng tin</td>
                      <td class="cellTable text-center">
                        <select
                          class="form-control-select"
    ...
    <template v-slot:sub_footer>
      <div class="bg-gray-100">
        <div class="p-4 text-left">
          <button class="button-modal" @click="createRoleGroup()">
            Cập nhật
          </button>
...
export default {
  ...
  methods: {
    ...
    createRoleGroup() {
      ...
      this.GroupUser.createAdminGroupAction({
        data: listRoleGroup,
        router: this.$router,
        toast: this.toast,
      });
