<template>
  <ul class="flex text-gray-400 py-3">
    ...
    >
      <router-link to="/approval-approval-approve/type=ALL"
    ...
    >
      <router-link to="/approval-approval-approve/type=WAITING"
    ...
    >
      <router-link to="/approval-approval-approve/type=APPROVING"
    ...
    >
      <router-link to="/approval-approval-approve/type=APPROVED"
    ...
    >
      <router-link to="/approval-approval-approve/type=NO_APPROVED"
...
export default {
  setup() {
    ...
    const { CountTab } = storeToRefs(confirm);
