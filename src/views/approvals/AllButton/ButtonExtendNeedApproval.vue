<template>
  ...
  >
    <ul class="bg-white p-2 rounded-md">
      <li
        class="w-44 sub-item"
        @click="this.$router.push('/approval-approval-approve/type=ALL')"
        :class="{
          subItemActive: checkRoute('Đơn từ bạn duyệt'),
        }"
      >
        Tất cả
      </li>
      <li
        class="w-44 sub-item"
        @click="this.$router.push('/approval-leave-view/type=confirm&menu=ALL')"
      ...
      <li
        class="w-44 sub-item"
        @click="
          this.$router.push('/approval-absence-view/type=confirm&menu=ALL')
        "
      ...
      <li
        class="w-44 sub-item"
        @click="
          this.$router.push('/approval-overtime-view/type=confirm&menu=ALL')
        "
      ...
      <li
        class="w-44 sub-item"
        @click="this.$router.push('/approval-inout-view/type=confirm&menu=ALL')"
      ...
      <li
        class="w-44 sub-item"
        @click="
          this.$router.push('/approval-shiftchange-view/type=confirm&menu=ALL')
        "
      ...
      <li
        class="w-44 sub-item"
        @click="
          this.$router.push('/approval-shiftmore-view/type=confirm&menu=ALL')
        "
      ...
      <li
        ...
        @click="
          this.$router.push(
            '/approval-shiftresgister-view/type=confirm&menu=ALL'
          )
        "
        :class="{
      ...
      <li
        class="w-44 sub-item"
        @click="
          this.$router.push('/approval-mission-view/type=confirm&menu=ALL')
        "
      ...
      <li
        class="w-44 sub-item"
        @click="
          this.$router.push('/approval-worktime-view/type=confirm&menu=ALL')
        "
      ...
      <li
        class="w-44 sub-item"
        @click="
          this.$router.push('/approval-resign-view/type=confirm&menu=ALL')
        "
      >
        Đơn thôi việc
      </li>
