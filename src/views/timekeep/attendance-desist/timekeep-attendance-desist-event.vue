  ...
  <person-layout>
      ...
      <navbar-social
        ><div class="flex grow">
          <div class="flex items-center">
            ...
            <p class="longText">Danh sách ngày nghỉ sự kiện, nghỉ bù</p>
          </div>
        </div></navbar-social
      >
    </template>
    ...
    <Transition name="slide-fade">
      <div class="w-full" v-if="isLoading == false">
        <!-- <table-responsive :header="headerGroup"></table-responsive> -->
...
export default {
  ...
  data() {
    return {
      headerGroup: ["Tiêu đề", "Từ ngày", "Đến ngày", "Trạng thái", "Ngày tạo"],
    };
  },
  methods: {
    formatDate(date) {
