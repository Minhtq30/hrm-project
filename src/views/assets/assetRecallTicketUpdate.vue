      ...
      <navbar-social>
        <div class="flex grow">
          <div class="flex items-center ml-4">
            ...
            <p class="ml-2 font-medium">Cập nhật thông tin thu hồi tài sản</p>
          </div>
        </div>
      </navbar-social>
    </template>
            ...
            <div class="w-full">
              <div class="border-b-[1px] pt-4 pb-1 text-left">
                ...
                <span class="font-medium" style="color: var(--color-primary)"
                  >Thông tin thu hồi tài sản</span
                >
              </div>
            </div>
                  ...
                  <div class="grid grid-cols-1 gap-2">
                    <div class="mt-2 text-left">
                      <label for="" class="form-group-label"
                        >Ngày thu hồi<span class="text-red-600"> *</span></label
                      >
                      <div>
                        <date-picker
                  ...
                  <div class="grid grid-cols-1">
                    <div class="mt-2 text-left">
                      <label for="" class="text-[12.6px]"
                        >Lý do thu hồi<span class="text-red-600">
                          *</span
                        ></label
                      >
                      <div class="mt-2">
...
export default {
  ...
  setup() {
    ...
    const recallTicketUpdate = () => {
      if (asset.value === undefined || asset.value === null) {
        toast.error("Tài sản đã bị xóa. Không thể sửa được thông tin");
      } else {
        const data = {
