      ...
      <navbar-social>
        <div class="flex grow">
          <div class="flex items-center ml-4">
            ...
            <p class="ml-2 font-medium">Sử dụng lại tài sản</p>
          </div>
        </div>
      </navbar-social>
    </template>
            ...
            <div class="w-full">
              <div class="border-b-[1px] pt-4 pb-1 text-left">
                ...
                <span class="font-medium" style="color: var(--color-primary)"
                  >Thông tin sử dụng lại tài sản</span
                >
              </div>
            </div>
            <div class="mt-1" v-if="!isHidden">
              <div class="w-full pl-2">
                <div class="pt-[12px]">
                      ...
                      <div class="mt-2">
                        <div class="placeholder:text-lg">
                          <v-select
                            ...
                            class="rounded-3xl"
                            v-model.number="assetTicket.supplier_id"
                            type="string"
                          >
                  ...
                  <div class="grid grid-cols-1">
                    <div class="mt-2 text-left">
                      <label for="" class="text-[12.6px]">Nội dung sửa</label>
                      <div class="mt-2">
                        <textarea
                  ...
                  <div class="grid grid-cols-2 gap-2">
                    <div class="mt-2 text-left">
                      ...
                      <div class="mt-2">
                        <CurrencyInput
                          v-model="assetTicket.actual_cost"
                          :options="{
                            currency: 'USD',
                    ...
                    <div class="mt-2 text-left">
                      <label for="" class="form-group-label"
                        >Thời gian khấu hao thêm<span class="italic"
                          >(tháng)</span
                        ></label
                      >
                      <div class="mt-2">
  ...
  setup() {
    ...
    const updateTicket = () => {
      const data = {
        ...
        actual_cost: assetTicket.value.actual_cost,
        ext_time: assetTicket.value.ext_time,
        force_update: 1,
        attachments: [],
        notes: [],
      };
