      ...
      <navbar-social>
        <div class="flex grow">
          <div class="flex items-center ml-4">
            ...
            <p class="ml-2 font-medium">Danh sách phiếu cấp phát tài sản</p>
          </div>
        </div>
      </navbar-social>
    </template>
        ...
        <div class="w-full">
          <table-responsive
            ...
            >
              ...
              <td class="p-3">{{ assetTicket?.user_assign_name }}</td>
              <td class="p-3">
                {{ assetTicket?.user_assign_detail?.position_name }}
              </td>
              <td class="p-3">
                {{ assetTicket?.user_assign_detail?.department_name }}
              </td>
  ...
  <div>
    <context-menu :isActive="isActiveAssetTicket"
      ><ul>
        ...
        <li @click.prevent="printTicket()">
          <a href="#"><i class="fal fa-print-search mr-4"></i>In phiếu</a>
        </li>
        <li @click.prevent="">
...
export default {
  ...
  setup() {
    ...
    const printTicket = () => {
      router.push(`/asset-ticket-print/${assetTicketDetail.value.id}`);
    };
    return {
