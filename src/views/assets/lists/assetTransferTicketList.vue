      ...
      <navbar-social>
        <div class="flex grow">
          <div class="flex items-center ml-4">
            ...
            <p class="ml-2 font-medium">Danh sách phiếu điều chuyển tài sản</p>
          </div>
        </div>
      </navbar-social>
    </template>
    ...
    <div class="w-full">
      <table-responsive
        ...
        >
          ...
          <td class="p-3">{{ assetTicket?.user_assignment_name }}</td>
          <td class="p-3">
            {{ assetTicket?.user_assignment_detail.department_name }}
          </td>
          <td class="p-3">
