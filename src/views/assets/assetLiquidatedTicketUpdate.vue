      ...
      <navbar-social>
        <div class="flex grow">
          <div class="flex items-center ml-4">
            ...
            <p class="ml-2 font-medium">Cập nhật phiếu thanh lý tài sản</p>
          </div>
        </div>
      </navbar-social>
    </template>
            ...
            <div class="w-full">
              <div class="border-b-[1px] pt-4 pb-1 text-left">
                ...
                <span class="font-medium" style="color: var(--color-primary)"
                  >Thông tin thanh lý tài sản</span
                >
              </div>
            </div>
                  ...
                  <div class="grid grid-cols-1 gap-2">
                    <div class="mt-2 text-left">
                      <label for="" class="form-group-label"
                        >Ngày thanh lý<span class="text-red-600">
                          *</span
                        ></label
                      >
                      <div>
