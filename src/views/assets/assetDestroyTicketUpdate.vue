      ...
      <navbar-social>
        <div class="flex grow">
          <div class="flex items-center ml-4">
            ...
            <p class="ml-2 font-medium">Cập nhật phiếu hủy tài sản</p>
          </div>
        </div>
      </navbar-social>
    </template>
                  ...
                  <div class="grid grid-cols-1 gap-2">
                    <div class="mt-2 text-left">
                      <label for="" class="form-group-label"
                        >Ngày hủy<span class="text-red-600 ml-1">
                          *</span
                        ></label
                      >
                      <div>
  ...
  setup() {
    ...
    const updateTicket = () => {
      if (asset.value === null || asset.value === undefined) {
        toast.error("Không thể sửa phiếu. Tài sản đã bị xóa.");
      } else {
        const data = {
